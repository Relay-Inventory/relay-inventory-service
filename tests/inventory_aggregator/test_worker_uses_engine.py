...
from inventory_aggregator.persistence.dynamo_tenants import TenantRecord
from inventory_aggregator.scripts.worker import Worker
from inventory_aggregator.util.errors import NonRetryableError
...
def test_worker_calls_engine(monkeypatch):
    ...
    def fake_run_inventory_sync(*, vendor_inputs, tenant_config, run_id, now):
        from inventory_aggregator.engine.run import EngineResult
    ...
    import inventory_aggregator.scripts.worker as worker_module
