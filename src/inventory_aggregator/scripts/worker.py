...
from inventory_aggregator.adapters.queue.sqs import SqsAdapter, SqsMessage
from inventory_aggregator.adapters.storage.s3 import S3Adapter
from inventory_aggregator.app.jobs.schema import RunJob
from inventory_aggregator.app.models.config import TenantConfig
from inventory_aggregator.engine.canonical.io import write_csv_bytes
from inventory_aggregator.engine.canonical.models import CANONICAL_COLUMNS
from inventory_aggregator.engine.run import (
    DecodeError,
    MissingRequiredColumnsError,
    run_inventory_sync,
    sku_map_input_key,
)
from inventory_aggregator.persistence.dynamo_runs import DynamoRuns
from inventory_aggregator.persistence.dynamo_tenants import DynamoTenants
from inventory_aggregator.util.errors import NonRetryableError, RetryableError
from inventory_aggregator.util.logging import get_logger, log_event
from inventory_aggregator.util.metrics import CloudWatchMetrics
...
class Worker:
    def __init__(
        ...
        *,
        ...
        self.cloudwatch_namespace = os.getenv("CLOUDWATCH_METRICS_NAMESPACE", "InventoryAggregator")
